...
pushd "${OSA_PATH}"
  ...
  ansible-playbook lxc-containers-destroy.yml -e "force_containers_destroy=yes" -e "force_containers_data_destroy=yes" --limit 'lxc_hosts:elasticsearch_all:kibana_all:logstash_all:elk_all'
